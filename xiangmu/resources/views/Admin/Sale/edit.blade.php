        ...
        <div class="panel-body">
            <div class="row">
                ...
                <div class="col-lg-6 col-lg-offset-3">
                     <form role="form" method="post" action="{{url('/Admin/Sale/update')}}" enctype="multipart/form-data">
                       ...
                       <div class="form-group">
                            <label>拍卖时间</label>
                            <!-- <input placeholder="输入拍卖时间" type="text" name="stime" value="{{$sales->stime}}" class="form-control"> -->
                        ...
                        <div class="form-group">
                            <label>结束时间</label>
                            <!-- <input placeholder="输入结束时间" type="text" name="ltime" value="{{$sales->ltime}}" class="form-control"> -->
